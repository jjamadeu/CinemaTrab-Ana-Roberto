...
<body>
    ...
    <div id="conteudo">
        ...
        <form action="./alterarFilme.php" method="get">
            ...
            <p>IDENTIFICADOR DO FILME: <label><input type='number' id="id" name="idFilme" min="1" step="1" value='<?= $filme->getIdFilme() ?>' required></label> </p>
            <p>TÍTULO: <label><input type='text' id="titulo" name="tituloFilme" maxlength="100" value='<?= $filme->getTitulo() ?>' required></label></p>
            <p>GÊNERO:<label>
            ...
            <p>
                SINOPSE: 
                <label>
                    <textarea name="sinopseFilme" maxlength="500" required><?= $filme->getSinopse() ?></textarea>
                </label>
            </p>
            ...
            <p>DURAÇÃO: <label><input type='time' name="duracaoFilme" min="00:01" max="05:00" value='<?= $filme->getDuracao() ?>' required></label> </p>
