    ...
    <div id='conteudo'>
        ...
        <form action="alterarSala.php" method="get">
           ...
           <input type="hidden" name="numSalaAntigo" value='<?= $sala->getNumero() ?>'> 
            ...
            <p> NÚMERO DA SALA:
                 <label><input type="number" id="numSala" name="numSala" min="1" step="1" value="<?= $sala->getNumero() ?>"></label>            
            </p>
            <p>LOTAÇÃO:
                 <label><input type="number" id="lotacao" name="lotacao" min="1" step="1" max="200" value="<?= $sala->getLotacao() ?>"></label>
            </p>
